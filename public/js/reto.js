        ...
        switch(dia) {
                ...
                contenido = `
                    ...
                    <div class="rutina-detalle">
                        <div class="rutina-img">
                            <img src="img/Reto/Bajar/g7.png" alt="Rutina HIIT"  style=" width: 90%;">
                        </div>
            ...
            case 2:
                contenido = `
                    ...
                    <div class="rutina-detalle">
                        <div class="rutina-img">
                            <img src="img/Reto/Bajar/g1.png" alt="Rutina Tren Inferior" style=" width: 90%;">
                        </div>
                        <div class="rutina-pasos">
                            ...
                            <p class="nota-importante">
                                <strong>NOTA:</strong> Toma PRE-ENTRENO GORILLA 30 minutos antes y BCAA GORILLA durante el entrenamiento para maximizar la recuperación.
                            </p>
                        </div>
                    </div>
                `;
            ...
            case 3:
                contenido = `
                    ...
                    <div class="rutina-detalle">
                        <div class="rutina-img">
                            <img src="img/Reto/Bajar/g8.png" alt="Rutina Cardio" style=" width: 90%;">
                        </div>
                        <div class="rutina-pasos">
                            <h4>CALENTAMIENTO (5 min)</h4>
                            <ul>
            ...
            case 4:
                contenido = `
                    ...
                    <div class="rutina-detalle">
                        <div class="rutina-img">
                            <img src="img/Reto/Bajar/g3.png" alt="Rutina Tren Superior" style=" width: 90%;">
                        </div>
                        <div class="rutina-pasos">
                            <h4>CALENTAMIENTO (8 min)</h4>
                            <ul>
                            ...
                            <h4>ENTRENAMIENTO PRINCIPAL (4 series)</h4>
                            <ul>
                                <li>Press de banca o push-ups (12-15 rep)</li>
                                <li>Remo con mancuerna (12 rep por brazo)</li>
                                <li>Press de hombros (12 rep)</li>
                                <li>Jalones al pecho (12-15 rep)</li>
                                <li>Curl de bíceps (12 rep)</li>
                                <li>Extensiones de tríceps (12 rep)</li>
                            </ul>
                            
                            <h4>FINALIZADOR (3 rondas)</h4>
                            <ul>
                                <li>Push-ups hasta el fallo</li>
                                <li>Plancha lateral (30 seg cada lado)</li>
                            </ul>
                            
                            <h4>ENFRIAMIENTO (5 min)</h4>
                            <ul>
                                <li>Estiramientos específicos de brazos y hombros</li>
                            </ul>
                            
                            <p class="nota-importante">
                                <strong>NOTA:</strong> Toma PRE-ENTRENO GORILLA 30 minutos antes y PROTEÍNA GORILLA inmediatamente después para maximizar la recuperación muscular.
                            </p>
                        </div>
                    </div>
                `;
            ...
            case 5:
                contenido = `
                    ...
                    <div class="rutina-detalle">
                        <div class="rutina-img">
                            <img src="img/Reto/Bajar/g4.png" alt="Circuito Metabólico" style=" width: 90%;">
                        </div>
                        <div class="rutina-pasos">
                            <h4>CALENTAMIENTO (5 min)</h4>
                            <ul>
            ...
            case 6:
                contenido = `
                    ...
                    <div class="rutina-detalle">
                        <div class="rutina-img">
                            <img src="img/Reto/Bajar/g6.png" alt="Recuperación Activa" style=" width: 90%;">
                        </div>
                        <div class="rutina-pasos">
            ...
            case 7:
                contenido = `
                    ...
                    <div class="rutina-detalle">
                        <div class="rutina-img">
                            <img src="img/Reto/Bajar/g5.png" alt="Día de Descanso" style=" width: 90%;">
                        </div>
                        <div class="rutina-pasos">
        ...
        switch(dia) {
            case 1:
                contenido = `
                    ...
                    <div class="rutina-detalle">
                        <div class="rutina-img">
                            <img src="img/Reto/Aumentar/image_fx_ (2).jpg" alt="Rutina Pecho y Tríceps" style=" width: 90%;">
                        </div>
                        <div class="rutina-pasos">
                            <h4>CALENTAMIENTO (8 min)</h4>
                            <ul>
            ...
            case 2:
                contenido = `
                    ...
                    <div class="rutina-detalle">
                        <div class="rutina-img">
                            <img src="img/Reto/Aumentar/g12.png" alt="Rutina Espalda y Bíceps" style=" width: 85%;">
                        </div>
                        <div class="rutina-pasos">
                            <h4>CALENTAMIENTO (8 min)</h4>
                            <ul>
            ...
            case 3:
                contenido = `
                    ...
                    <div class="rutina-detalle">
                        <div class="rutina-img">
                            <img src="img/Reto/Aumentar/g17.png" alt="Día de Descanso Activo" style=" width: 90%;>
                        </div>
                        <div class="rutina-pasos">
            ...
            case 4:
                contenido = `
                    ...
                    <div class="rutina-detalle">
                        <div class="rutina-img">
                            <img src="img/Reto/Aumentar/g5.png" alt="Rutina Piernas y Glúteos" style=" width: 90%;>
                        </div>
                        <div class="rutina-pasos">
            ...
            case 5:
                contenido = `
                    ...
                    <div class="rutina-detalle">
                        <div class="rutina-img">
                            <img src="img/Reto/Aumentar/g13.png" alt="Rutina Hombros y Abdomen" style=" width: 90%;>
                        </div>
                        <div class="rutina-pasos">
                            <h4>CALENTAMIENTO (8 min)</h4>
                            <ul>
            ...
            case 6:
                contenido = `
                    ...
                    <div class="rutina-detalle">
                        <div class="rutina-img">
                            <img src="img/Reto/Aumentar/g14.png" alt="Entrenamiento Compuesto" style=" width: 90%;>
                        </div>
                        <div class="rutina-pasos">
                            <h4>CALENTAMIENTO (10 min)</h4>
                            <ul>
            ...
            case 7:
                contenido = `
                    ...
                    <div class="rutina-detalle">
                        <div class="rutina-img">
                            <img src="img/Reto/Aumentar/g18.png" alt="Día de Descanso" style=" width: 90%;>
                        </div>
                        <div class="rutina-pasos">
                            <h4>DESCANSO COMPLETO</h4>
